								...
								<table class="table text-md-nowrap" id="example1">
									<thead>
										<tr>
											...
											<th class="wd-15p border-bottom-0">{{ __('admin.department_name') }}</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												@endcan
												@can('departments_delete')
												<a class="modal-effect btn btn-danger-gradient" data-effect="effect-newspaper" data-route="{{ $routeName }}" data-id="{{ $record->id }}" data-name="{{ $record->department_name }}" data-toggle="modal" href="#modaldemo8">
													<i class="las la-trash"></i>
												</a>
												@endcan
											</td>
