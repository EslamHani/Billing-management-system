								...
								<table class="table text-md-nowrap" id="example1">
									<thead>
										<tr>
											...
											<th class="wd-10p border-bottom-0">{{ __('admin.image') }}</th>
											<th class="wd-10p border-bottom-0">{{ __('admin.email') }}</th>
											<th class="wd-10p border-bottom-0">{{ __('admin.roles') }}</th>
											<th class="wd-10p border-bottom-0">{{ __('admin.status') }}</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<img alt="{{ $record->name }}" src="{{ asset($record->image) }}" class="img-thumbnail" width="50" height="50">
												@endif
											</td>
											<td>{{ $record->email }}</td>
											<td>
												@foreach($record->roles as $role)
													<button type="button" class="btn btn-primary btn-sm" style="margin: 2px;">
														{{ $role->name }}
													</button>
												@endforeach
											</td>
											...
											<td>
												...
												<div class="dropdown">
													...
													<div class="dropdown-menu tx-13">
														...
														@endcan
														@can('users_delete')
														<a class="modal-effect dropdown-item" data-effect="effect-newspaper" data-route="users" data-id="{{ $record->id }}" data-name="{{ $record->name }}" data-toggle="modal" href="#modaldemo8" title="delete">
