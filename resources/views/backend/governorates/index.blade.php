...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			...
			<span class="text-muted mt-1 tx-13 mr-2 mb-0">\ {{ __('admin.'.$pageName) }}
</span>
		</div>
	</div>
</div>
								...
								<table class="table text-md-nowrap" id="example1">
									<thead>
										<tr>
											...
											<th class="wd-15p border-bottom-0">{{ __('admin.governorates') }}</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												@can('governorates_update')
												<a href="{{ route($routeName.'.edit', $record) }}" class="btn btn-info-gradient" title="edit">
													<i class="las la-pen"></i>
												</a>
												@endcan
												@can('governorates_delete')
												<a class="modal-effect btn btn-danger-gradient" data-effect="effect-newspaper" data-route="{{ $routeName }}" data-id="{{ $record->id }}" data-name="{{ $record->governorate }}" data-toggle="modal" href="#modaldemo8">
													<i class="las la-trash"></i>
												</a>
												@endcan
											</td>
