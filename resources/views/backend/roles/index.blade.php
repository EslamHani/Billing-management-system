								...
								<table class="table text-md-nowrap" id="example1">
									<thead>
										<tr>
											...
											<th class="wd-20p border-bottom-0">{{ __('admin.name') }}</th>
											...
											<td>
												...
												<div class="dropdown">
													...
													<div class="dropdown-menu tx-13">
														...
														@endcan
														@can('roles_delete')
														<a class="modal-effect dropdown-item" data-effect="effect-newspaper" data-route="roles" data-id="{{ $record->id }}" data-name="{{ $record->name }}" data-toggle="modal" href="#modaldemo8" title="delete">
